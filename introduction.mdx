...
description: "next-dev-portfolio is a Next.js 15 portfolio template with a visual CMS, schema-validated content, and one-click Vercel deployment powered by OlonJS."
---
