...
description: "Use Studio at /admin to edit page sections, blog posts, and case studies. Changes save as JSON and can be committed to your GitHub repo via Save2Repo."
---
