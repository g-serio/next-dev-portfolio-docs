...
description: "Studio is the built-in CMS for next-dev-portfolio. Access it at /admin to edit any section of your site visually, with changes committed back to your GitHub repo."
---
...
Studio is served from `app/admin/[[...slug]]/page.tsx` and renders an editable view of your portfolio content. Every page section exposes form fields generated directly from its Zod schema, so the editor always stays in sync with the shape of your data.
